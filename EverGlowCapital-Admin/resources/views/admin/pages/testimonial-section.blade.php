        ...
        <div class="testimonial-section">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="text" id="testimonial_section_heading" name="testimonial_section_heading"
                    class="form-control" value="{{old('testimonial_section_heading')}}" />
                <br>
                <!-- Testimonial image -->
                ...
                @error('testimonial_image')
                    <span class="txt text-danger">* {{$message}}</span>
                @enderror
                <input type="file" id="testimonial_image" name="testimonial_image" class="form-control" value="" />
                <br>
                <!-- Testimonial heading -->
                ...
                <input type="text" id="testimonial_shortdesc" name="testimonial_shortdesc" class="form-control"
                    value="{{old('testimonial_shortdesc')}}" />
                <br>
                ...
                <input type="text" id="testimonial_author_position" name="testimonial_author_position"
                    class="form-control" value="{{old('testimonial_author_position')}}" />
                <br>
                <a href=""><button class="btn btn-primary">Add Testimonial</button></a>
