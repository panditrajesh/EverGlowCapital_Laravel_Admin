    ...
    <div class="container-fluid">
        <div class="subscription-field">
            ...
            <form action="" method="post">
                @csrf
                <div class="mb-3">
                    <input type="hidden" name="hidden_id" value="{{$subscriptions->subscription_id}}">
                    ...
                    <input class="form-control" type="text" name="subscription_heading" id="subscription_heading"
                        value="{{$subscriptions->subscription_heading}}">
                </div>
                <div class="mb-3">
                    ...
                    @error('subscription_para')
                        <span class="txt text-danger">* {{$message}}</span>
                    @enderror
                    <input class="form-control" type="text" id="subscription_para" name="subscription_para"
                        value="{{$subscriptions->subscription_para}}" multiple>
                </div>
                <a href="{{route("admin.subscription.update", $subscriptions->subscription_id)}}"><button
