    ...
    <div class="container-fluid">
        <div class="subscription-field">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="hidden_id" data-id="{{$benefits->benefit_id}}">
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" id="benefit_heading" name="benefit_heading"
                        value="{{$benefits->benefit_heading}}">
                </div>
                <div class="box-model">
                    <div class="mb-3">
                    ...
                    <div>
                        ...
                        <input class="form-control form-control-lg" id="benefit_desc" name="benefit_desc" type="text"
                            value="{{$benefits->benefit_desc}}">
                    </div>
                </div>
                <br>
                <a href="{{route("admin.benefit.update", $benefits->benefit_id)}}"><button
